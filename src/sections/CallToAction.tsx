...
function CallToAction() {
  return (
    <section className='p-0 w-full h-75 bg-secondary md:h-100 md:flex md:items-center'>
      <div className='p-2.5 my-5 md:px-12.5 md:flex md:items-center md:justify-center'>
